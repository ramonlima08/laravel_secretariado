                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 pr-1">
                                <div class="form-group">
                                    <label>CNPJ</label>
                                    <input name="cnpj" type="text" class="form-control" {{ $disabled ?? '' }} placeholder="00.000.000/0000-00"
                            ...
                            <div class="col-md-6 pl-1">
                                <div class="form-group">
                                    ...
                                    <input name="telephone" type="text" class="form-control" {{ $disabled ?? '' }} placeholder="(xx) xxxx-xxxx"
